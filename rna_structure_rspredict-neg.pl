...
foreach my $file (@allfiles) {
	...
	$rspredict_file = $file;
	$rspredict_file =~ s/-ran/-rspredict/;
...
print "negative,$combo,$rspredict_struct,$bp,$loop_number,$largest_loop_length,$largest_bulge_length,$rspredict_hairpin_length,$max_consecutive_base_pairs,$rspredict_length,$rspredict_APSI,$rspredict_pairing_threshold,$rspredict_energy_density";
