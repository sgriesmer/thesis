...
foreach my $file (@allfiles) {
	...
	$rnafold_file = $file;
	$rnafold_file =~ s/-ran/-rnafold/;

	$centroidfold_file = $file;
	$centroidfold_file =~ s/-ran/-centroidfold/;
...
print "$sample_type,$combo,$rnafold_struct,$bp,$loop_number,$largest_loop_length,$largest_bulge_length,$rnafold_hairpin_length,$max_consecutive_base_pairs,$rnafold_length,";
